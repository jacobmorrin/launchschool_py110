...
Write a function that takes two arguments, an ID and a list. The function should return a list
containing only the transactions with the corresponding ID.
